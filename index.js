      ...
      "https://api.anthropic.com/v1/messages",
      {
        ...
        messages: [{
          ...
          content: [
            ...
            {
              type: "text",
              text: `この画像はヤマト運輸の伝票です。各伝票の左側に縦に並んだ項目欄があり、その中に「品名」という印字があります。「品名」の右横または下に書かれた文字（「M2.5-1ヶ月」「M2.5-3ヶ月」などの英数字や記号の組み合わせ）のみを読み取ってください。\n\n※絶対に無視すること：宛名（〇〇様）・住所・電話番号・伝票番号・バーコード\n※品名は必ず英字や数字や記号を含む文字列です。人名は品名ではありません。\n\n【正しい品名リスト】\n${slackItems.join(", ")}\n\n以下の2点を確認してください：\n1. 読み取ったすべての品名が品名リストと一致しているか\n${refrigerationRule}\n\n【品名に関する返答ルール】\n- 品名がすべて一致し、冷蔵チェックも問題なければ：「確認済み✅」とだけ返してください。\n- 品名が一つでも不一致の場合：「⚠️ 誤りがあるので目視で確認してください」と不一致の品名を返してください。`
            }
          ]
        }]
      },
